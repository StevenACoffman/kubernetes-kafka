...
```
$ kubectl apply -f ./fluent-bit/output/kafka/fluent-bit-configmap.yaml
```
...
```
$ kubectl apply -f ./fluent-bit/output/kafka/fluent-bit-ds.yaml
```
...
```
$ kubectl create -f ./fluent-bit/output/kafka/fluent-bit-ds-minikube.yaml
```
